...
class UT_JewishDateNavigation {
    ...
    fun jewishForwardMonthToMonth() {
        ...
        assertEquals(5, jewishDate.gregorianLocalDate.day)
        assertEquals(3, jewishDate.gregorianLocalDate.month.number - 1)
    ...
    fun computeRoshHashana5771() {
        ...
        assertEquals(9, jewishDate.gregorianLocalDate.day)
        assertEquals(8, jewishDate.gregorianLocalDate.month.number - 1)
