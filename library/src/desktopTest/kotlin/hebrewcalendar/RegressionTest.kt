...
//        calc.isUseElevation = true
        ...
        for (line in lines) {
            ...
            try {
                ...
                assertEquals(fields[1].removeSurrounding(quote), jewishDate.toString())
//                assertYomTovOrParshaMatches(jewishDate, jewishCalendar, fields, quote)
                ...
                var col = 4
                assertEquals(fields[col++], jewishCalendar.dafYomiBavli?.let { "${it.masechtaTransliterated} ${it.daf}" })
                assertEquals(fields[col++], calc.alos120.fmt())
                assertEquals(fields[col++], calc.alos120Zmanis.fmt())
                assertEquals(fields[col++], calc.alos26Degrees.fmt())
                assertEquals(fields[col++], calc.alos96.fmt())
                assertEquals(fields[col++], calc.alos96Zmanis.fmt())
                assertEquals(fields[col++], calc.alos19Point8Degrees.fmt())
                assertEquals(fields[col++], calc.alos19Degrees.fmt())
                assertEquals(fields[col++], calc.alos90.fmt())
                assertEquals(fields[col++], calc.alos90Zmanis.fmt())
                assertEquals(fields[col++], calc.alos18Degrees.fmt())
                assertEquals(fields[col++], calc.alosBaalHatanya.fmt())
                assertEquals(fields[col++], calc.alos16Point1Degrees.fmt())
                assertEquals(fields[col++], calc.alos72.fmt())
                assertEquals(fields[col++], calc.alos72Zmanis.fmt())
//                assertEquals(fields[col++], calc.alos60.fmt())
                assertEquals(fields[col++], calc.misheyakir11Point5Degrees.fmt())
                assertEquals(fields[col++], calc.misheyakir11Degrees.fmt())
                assertEquals(fields[col++], calc.misheyakir10Point2Degrees.fmt())
                assertEquals(fields[col++], calc.misheyakir9Point5Degrees.fmt())
                assertEquals(fields[col++], calc.misheyakir7Point65Degrees.fmt())
//                assertEquals(fields[col++], calc.sunrise.fmt())
                assertEquals(fields[col++], calc.seaLevelSunrise.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaMGA120Minutes.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaMGA16Point1Degrees.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaMGA18Degrees.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaMGA19Point8Degrees.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaMGA72Minutes.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaMGA72MinutesZmanis.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaMGA90Minutes.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaMGA90MinutesZmanis.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaMGA96Minutes.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaMGA96MinutesZmanis.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaAlos16Point1ToSunset.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaAlos16Point1ToTzaisGeonim7Point083Degrees.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaMGA16Point1DegreesToFixedLocalChatzos.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaMGA18DegreesToFixedLocalChatzos.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaMGA90MinutesToFixedLocalChatzos.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaMGA72MinutesToFixedLocalChatzos.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaGRASunriseToFixedLocalChatzos.fmt())
                assertEquals(fields[col++], calc.sofZmanShma3HoursBeforeChatzos.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaAteretTorah.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaBaalHatanya.fmt())
                assertEquals(fields[col++], calc.sofZmanShmaGRA.fmt())
                assertEquals(fields[col++], calc.sofZmanTfilaMGA120Minutes.fmt())
                assertEquals(fields[col++], calc.sofZmanTfilaMGA16Point1Degrees.fmt())
                assertEquals(fields[col++], calc.sofZmanTfilaMGA18Degrees.fmt())
                assertEquals(fields[col++], calc.sofZmanTfilaMGA19Point8Degrees.fmt())
                assertEquals(fields[col++], calc.sofZmanTfilaMGA72Minutes.fmt())
                assertEquals(fields[col++], calc.sofZmanTfilaMGA72MinutesZmanis.fmt())
                assertEquals(fields[col++], calc.sofZmanTfilaMGA90Minutes.fmt())
                assertEquals(fields[col++], calc.sofZmanTfilaMGA90MinutesZmanis.fmt())
                assertEquals(fields[col++], calc.sofZmanTfilaMGA96Minutes.fmt())
                assertEquals(fields[col++], calc.sofZmanTfilaMGA96MinutesZmanis.fmt())
                assertEquals(fields[col++], calc.sofZmanTfilaGRASunriseToFixedLocalChatzos.fmt())
                assertEquals(fields[col++], calc.sofZmanTfila2HoursBeforeChatzos.fmt())
                assertEquals(fields[col++], calc.sofZmanTfilahAteretTorah.fmt())
                assertEquals(fields[col++], calc.sofZmanTfilaBaalHatanya.fmt())
                assertEquals(fields[col++], calc.sofZmanTfilaGRA.fmt())
                assertEquals(fields[col++], calc.chatzos.fmt())
                assertEquals(fields[col++], calc.fixedLocalChatzos.fmt())

                assertEquals(fields[col++], calc.minchaGedola.fmt()) // Mincha Gedola GRA in spreadsheet
                assertEquals(fields[col++], calc.minchaGedolaBaalHatanya.fmt())
                assertEquals(fields[col++], calc.minchaGedola72Minutes.fmt())
                assertEquals(fields[col++], calc.minchaGedola16Point1Degrees.fmt())
                assertEquals(fields[col++], calc.minchaGedolaAteretTorah.fmt())
                assertEquals(fields[col++], calc.minchaGedolaGreaterThan30.fmt())
                assertEquals(fields[col++], calc.minchaGedolaBaalHatanyaGreaterThan30.fmt())
                assertEquals(fields[col++], calc.minchaGedolaGRAFixedLocalChatzos30Minutes.fmt())
                assertEquals(fields[col++], calc.minchaGedolaAhavatShalom.fmt())

                assertEquals(fields[col++], calc.samuchLeMinchaKetanaGRA.fmt())

                assertEquals(fields[col++], calc.minchaKetana.fmt()) //gra?
                assertEquals(fields[col++], calc.minchaKetanaBaalHatanya.fmt())
                assertEquals(fields[col++], calc.samuchLeMinchaKetana16Point1Degrees.fmt())
                assertEquals(fields[col++], calc.minchaKetana16Point1Degrees.fmt())
                assertEquals(fields[col++], calc.samuchLeMinchaKetana72Minutes.fmt())
                assertEquals(fields[col++], calc.minchaKetana72Minutes.fmt())
                assertEquals(fields[col++], calc.minchaKetanaAteretTorah.fmt())
                assertEquals(fields[col++], calc.minchaKetanaGRAFixedLocalChatzosToSunset.fmt())
                assertEquals(fields[col++], calc.minchaKetanaAhavatShalom.fmt())

                assertEquals(fields[col++], calc.plagHamincha.fmt())
// Plag Hamincha
...
// Hallel Shalem
    ...
    private fun getParshaOrYomTov(jewishCalendar: sternbach.software.kosherkotlin.hebrewcalendar.JewishCalendar) =
        hdf
