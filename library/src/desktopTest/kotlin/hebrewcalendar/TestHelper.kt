...
// kotlinx-datetime 0.8.0 moved Instant interop to kotlin.time; provide helpers for tests
...
fun java.time.Instant.toKotlinInstant(): kotlin.time.Instant =
    kotlin.time.Instant.fromEpochSeconds(epochSecond, nano.toLong())
