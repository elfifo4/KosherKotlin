...
class UT_DaysInGregorianMonth {
    ...
    private fun JewishDate.assertDaysInMonth(
        ...
        assertEquals(31, 1.lastDayOfGregorianMonth.toLong())
        assertEquals(if (febIsLeap) 29 else 28.toLong(), 2.lastDayOfGregorianMonth.toLong())
        assertEquals(31, 3.lastDayOfGregorianMonth.toLong())
        assertEquals(30, 4.lastDayOfGregorianMonth.toLong())
        assertEquals(31, 5.lastDayOfGregorianMonth.toLong())
        assertEquals(30, 6.lastDayOfGregorianMonth.toLong())
        assertEquals(31, 7.lastDayOfGregorianMonth.toLong())
        assertEquals(31, 8.lastDayOfGregorianMonth.toLong())
        assertEquals(30, 9.lastDayOfGregorianMonth.toLong())
        assertEquals(31, 10.lastDayOfGregorianMonth.toLong())
        assertEquals(30, 11.lastDayOfGregorianMonth.toLong())
        assertEquals(31, 12.lastDayOfGregorianMonth.toLong())
    }
